   ...
   */
   /**
    ...
    moveMinToFront() {
        ...
        while (runner.next != null) {
            if(small > runner.data){
                runner = runner.next
            }
            while (small != runner.next) {
                runner = runner.next
            }
...
// secondThreeList.insertAtFront(1);
...
// console.log(firstThreeList.concat(emptyList))
console.log(emptyList.concat(biNodeList))
